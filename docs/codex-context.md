...
- PGx-рекомендации расширять сначала через курируемые источники CPIC A/B, PharmGKB/FDA/DPWG, а не через одиночные исследования без evidence-level.
...
3. Добавить комбинированные PGx-алгоритмы для варфарина и фторпиримидинов поверх уже добавленных отдельных gene-drug сигналов.
